...
async function applicationsView() {
  ...
  const forms = available.length ? node('div', { class: 'two-column' }, panel('Create PHP application', createForm('php')), panel('Create Python application', createForm('python')), panel('Create Node.js application', createForm('node'))) : empty('Create and activate an unused customer domain first.');
